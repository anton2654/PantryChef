...
('Кукурудза', 'Овочі', 96, 3.5, 1.5, 21.0, 'https://vip.shuvar.com/media/catalog/product/cache/628b1a33a4779cd89563027f2a2c1a58/8/a/8a3984fc-0306-4ba0-8ec2-d5123e54a988.jpeg');");
            ...
            migrationBuilder.Sql(
                @"INSERT INTO user_ingredient (""UserId"", ""IngredientId"", ""Quantity"") VALUES
-- Перша партія
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Апельсин'), 1000),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Яблуко'), 500),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Морква'), 400),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Огірок'), 300),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Ківі'), 600),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Авокадо'), 200),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Перець болгарський'), 300),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Броколі'), 450),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Полуниця'), 300),
-- Друга партія
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Банан'), 800),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Ананас'), 1),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Виноград'), 450),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Персик'), 600),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Черешня'), 500),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Кавун'), 1),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Помідор'), 750),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Часник'), 100),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Шпинат'), 150),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Кукурудза'), 350),
(1, (SELECT ""Id"" FROM ingredient WHERE ""Name"" = 'Гриби'), 400);");
